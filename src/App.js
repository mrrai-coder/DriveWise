...
// About component defined directly in App.js
...
function App() {
  ...
  const navigate = (page, params = {}) => {
    console.log("App.js: Setting currentPage to:", page, "with params:", params)
    setCurrentPage(page)
    if (params.carId) {
      setSelectedCarId(params.carId)
    }
    if (params.filter) {
  ...
  console.log("App.js: Rendering with currentPage:", currentPage, "selectedCarId:", selectedCarId, "filter:", filter)

  return (
    <div className="app-container">
      {currentPage === "home" && <HomePage navigate={navigate} />}
      {currentPage === "all-cars" && <AllCars navigate={navigate} filter={filter} />}
      {currentPage === "car-recommendation" && <CarRecommendationPage navigate={navigate} />}
      {currentPage === "about" && <About navigate={navigate} />}
      {currentPage === "sell-car" && <SellCarPage navigate={navigate} />}
      {currentPage === "car-details" && <CarDetails navigate={navigate} carId={selectedCarId} />}
    </div>
  )
}
